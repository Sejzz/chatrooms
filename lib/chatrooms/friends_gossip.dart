...
import 'package:chatrooms/pages/chatroommodel.dart';
...
class friends extends StatefulWidget {
 ...
 // final String username;
  ...
  @override
  State<friends> createState() => _friendsState(obtainedusername: obtainedusername);
}

class _friendsState extends State<friends> {
  String obtainedusername;
   _friendsState({required this.obtainedusername});
